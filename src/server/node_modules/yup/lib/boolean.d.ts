...
export default class BooleanSchema<TType extends Maybe<boolean> = boolean | undefined, TContext extends AnyObject = AnyObject, TOut extends TType = TType> extends BaseSchema<TType, TContext, TOut> {
    ...
    isTrue(message?: import("yup/lib/types").Message<{}> | undefined): BooleanSchema<TType | true, TContext, true | Optionals<TOut>>;
    isFalse(message?: import("yup/lib/types").Message<{}> | undefined): BooleanSchema<TType | false, TContext, false | Optionals<TOut>>;
}
