...
import type { Defined, If, Thunk } from 'yup/lib/util/types';
...
export default class NumberSchema<TType extends Maybe<number> = number | undefined, TContext extends AnyObject = AnyObject, TOut extends TType = TType> extends BaseSchema<TType, TContext, TOut> {
    ...
    min(min: number | Reference<number>, message?: import("yup/lib/types").Message<{
        min: number;
    }>): this;
    max(max: number | Reference<number>, message?: import("yup/lib/types").Message<{
        max: number;
    }>): this;
    lessThan(less: number | Reference<number>, message?: import("yup/lib/types").Message<{
        less: number;
    }>): this;
    moreThan(more: number | Reference<number>, message?: import("yup/lib/types").Message<{
        more: number;
    }>): this;
    positive(msg?: import("yup/lib/types").Message<{
        more: number;
    }>): this;
    negative(msg?: import("yup/lib/types").Message<{
        less: number;
    }>): this;
    integer(message?: import("yup/lib/types").Message<{}>): this;
    truncate(): this;
