...
import { InternalOptions, Callback, Maybe, Optionals, Preserve } from 'yup/lib/types';
import type { TypedSchema, Defined } from 'yup/lib/util/types';
import type Reference from 'yup/lib/Reference';
import Lazy from 'yup/lib/Lazy';
import BaseSchema, { AnySchema, SchemaObjectDescription, SchemaSpec } from 'yup/lib/schema';
...
export default class ObjectSchema<TShape extends ObjectShape, TContext extends AnyObject = AnyObject, TIn extends Maybe<TypeOfShape<TShape>> = TypeOfShape<TShape>, TOut extends Maybe<AssertsShape<TShape>> = AssertsShape<TShape> | Optionals<TIn>> extends BaseSchema<TIn, TContext, TOut> {
    ...
    noUnknown(noAllow?: boolean, message?: import("yup/lib/types").Message<{}>): this;
    unknown(allow?: boolean, message?: import("yup/lib/types").Message<{}>): this;
